...
public class Fournisseur implements Serializable {
	...
	public String toString() {
		return "Fournisseur [idFournisseur=" + idFournisseur + ", code=" + code + ", libelle=" + libelle
				...
				+ secteurActivites + ", detailFournisseur=" + detailFournisseur + ", getIdFournisseur()="
				+ getIdFournisseur() + ", getCode()=" + getCode() + ", getLibelle()=" + getLibelle()
				+ ", getCategorieFournisseur()=" + getCategorieFournisseur() + ", getFactures()=" + getFactures()
				+ ", getSecteurActivites()=" + getSecteurActivites() + ", getDetailFournisseur()="
				+ getDetailFournisseur() + "]";
	}
